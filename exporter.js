...
// 線データの読み込みボタンを設置
// -------------------------------------------------
export function setupLineLoader(scene) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        lineButton.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch('/Temp/points.txt');
...
// 保存処理
// -------------------------------------------------
export function exportJointData(points) {
